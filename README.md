...
- <a href='http://www.ssjcbc.com/bibleresearch/bible_reaserch2.html'>mapping Chinese Equivalent Koine Grammar And Syntax</a> - <a href='https://github.com/eliranwong/OpenGNT/blob/master/mapping_BRSI/OGNTmappingCEKGAS.csv'>DONE</a>
- mapping "<a href='http://netbible.com/' target='_blank'>The NET Bible® verse text (no Notes) - 2nd Edition; New Testament</a>" --- <a href='https://github.com/eliranwong/OpenGNT/blob/master/OpenGNT_interlinear_NET2.csv.zip'>2nd screening in progress</a><br>
- mapping "<a href='http://chinesestandardbible.com'>The CHINESE STANDARD BIBLE© Simplified and Traditional texts</a>" --- <a href='https://github.com/eliranwong/OpenGNT/blob/master/OpenGNT_interlinear_CSBtc.csv.zip'>First draft; CHECKING in progress</a><br>
- mapping "Chinese Union Version" --- <a href='https://github.com/eliranwong/OpenGNT/blob/master/OpenGNT_interlinear_CUVtc.csv.zip'>First draft; CHECKING in progress</a><br>
