...
- mapping "<a href='http://netbible.com/' target='_blank'>The NET Bible® verse text (no Notes) - 2nd Edition; New Testament</a>" (1st draft uploaded <a href='https://github.com/eliranwong/OpenGNT/blob/master/OpenGNT_interlinear_NET2.csv.zip'>HERE</a>; subject to on-going revision)<br>
- mapping "The CHINESE STANDARD BIBLE© Simplified and Traditional texts" --- <a href='https://github.com/eliranwong/OpenGNT/blob/master/OpenGNT_interlinear_CSBtc.csv.zip'>First draft; CHECKING in progress</a><br>
