...
- in addition to sub-meanings, which had already been worked out above, OpenGNT Project is working on sub-meanings for the rest of the text, to provide a full set of context-sensitive glosses for OpenGNT [<a href='https://github.com/eliranwong/OpenGNT/blob/master/OpenGNT.csv.zip'>Find regular updates HERE</a>; read file description above.]
