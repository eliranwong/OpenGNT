...
- mapping "<a href='http://netbible.com/' target='_blank'>The NET Bible® verse text (no Notes) - 2nd Edition; New Testament</a>" --- <a href='https://github.com/eliranwong/OpenGNT/blob/master/OpenGNT_interlinear_NET2.csv.zip'>First draft; CHECKING in progress</a><br>
